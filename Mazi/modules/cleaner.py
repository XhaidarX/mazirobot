...
from Mazi import ALLOW_EXCL, CustomCommandHandler, dispatcher
...
from Mazi.modules.sql import cleaner_sql as sql
...
❂ • /gignoreblue <kata>*:* secara global mengabaikan pembersihan teks biru dari kata yang disimpan di seluruh Mazi.
