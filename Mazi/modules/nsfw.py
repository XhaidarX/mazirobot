...
from Mazi import dispatcher, updater
import Mazi.modules.sql.nsfw_sql as sql
from Mazi.modules.log_channel import gloggable
...
⩺ /avatar cabul: Mengirim Stiker Avatar Cabul Secara Acak.
...
❂ /erofeet: Mengirimkan Gambar sumber Ero-Feet Acak.
❂ /holo: Mengirim Gambar sumber Holo Acak.
❂ /tits: Mengirim Gambar Sumber Payudara Acak.
...
❂ /kuni: Mengirim GIF Menjilat Pussy Acak.
❂ /waifu: Mengirim Stiker Waifu Acak.
❂ /kiss: Mengirim GIF Kissing Acak.
