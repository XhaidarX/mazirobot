...
from Mazi import DRAGONS, dispatcher
...
from Mazi.modules.helper_funcs.admin_rights import (
    user_can_changeinfo,
    user_can_promote,
)
...
⩺ /pin*:* diam-diam menyematkan pesan yang dibalas - tambahkan `'loud'` atau `'notify'` untuk memberikan pemberitahuan kepada pengguna
...
⩺ /purge <integer X>*:* menghapus pesan yang dibalas, dan X pesan yang mengikutinya jika membalas sebuah pesan.
