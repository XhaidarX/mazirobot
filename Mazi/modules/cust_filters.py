...
from Mazi import dispatcher, LOGGER, DRAGONS
...
from Mazi.modules.helper_funcs.chat_status import user_admin
from Mazi.modules.helper_funcs.extraction import extract_text
from Mazi.modules.helper_funcs.filters import CustomFilters
from Mazi.modules.helper_funcs.misc import build_keyboard_parser
from Mazi.modules.helper_funcs.msg_types import get_filter_type
...
from Mazi.modules.sql import cust_filters_sql as sql
from Mazi.modules.connection import connected
from Mazi.modules.helper_funcs.alternate import send_message, typing_action
...
*Hanya admin:*
❂ /filter <katakunci> <membalas pesan>*:* Tambahkan filter ke obrolan ini. Bot sekarang akan membalas pesan itu setiap kali 'kata kunci''\
...
❂ /stop <nama filter>*:* Hentikan filter itu.
