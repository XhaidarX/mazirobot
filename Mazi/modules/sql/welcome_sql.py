...
from Mazi.modules.helper_funcs.msg_types import Types
from Mazi.modules.sql import BASE, SESSION
...
DEFAULT_WELCOME_MESSAGES = [
    ...
    "{first} baru bergabung. apakah kamu membutuhkan mazi?",  # Steins Gate
    ...
    "hei lihatlah owner saya @kenapatagdar?",  # jojo jap ver
    "Aku tidak bisa mengalahkanmu tanpa mendekat",  # jojo
    "Hoho! Lalu datanglah sedekat yang kamu mau.", #jojo
    "Hoho! Dewa juubun chimazikanai youi", #jojo jap ver
...
DEFAULT_GOODBYE_MESSAGES = [
    ...
    "Selamat, {pertama}! Anda resmi bebas dari kekacauan ini.",
