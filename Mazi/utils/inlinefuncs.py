...
from Mazi import pbot as app
from Mazi import arq
from Mazi.services.keyboard import Ikb
from Mazi.utils.pluginhelper import (
    convert_seconds_to_minutes as time_convert,
    fetch,
)
from Mazi.services.tasks import _get_tasks_text, all_tasks, rm_task
from Mazi.services.types import InlineQueryResultCachedDocument
from Mazi.modules.info import get_chat_info, get_user_info
from Mazi.modules.music import download_youtube_audio
from Mazi.utils.functions import test_speedtest
from Mazi.utils.pastebin import paste
...
async def alive_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("Main bot", url="https://t.me/Dark_musikbot"),
        InlineKeyboardButton("Go Inline!", switch_inline_query_current_chat=""),
    )

    msg = f"""
**[ᴋᴀᴢᴜ ꭙ ꝛᴏʙᴏᴛ](https://t.me/Dark_musikbot):**
**MainBot:** `{bot_state}`
**UserBot:** `{ubot_state}`
...
**Profiles:** [BOT](t.me/{BOT_USERNAME}) | [κ λ z υ](t.me/kenapatagkazu)
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
            description="Check Bot's Stats",
            thumb_url="https://telegra.ph/file/05c7982e106962b905ef4.jpg",
            input_message_content=InputTextMessageContent(
...
async def music_inline_func(answers, query):
    chat_id = -1001837838911
    group_invite = "https://t.me/joinchat/logsmusik"
    try:
        messages = [
            m
