...
import Mazi.modules.sql.global_bans_sql as sql
from Mazi.modules.sql.users_sql import get_user_com_chats
from Mazi import (
    DEV_USERS,
    EVENT_LOGS,
    OWNER_ID,
...
from Mazi.modules.helper_funcs.misc import send_to_list
