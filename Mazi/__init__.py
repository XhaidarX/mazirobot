...
def get_user_list(__init__, key):
    with open("{}/Mazi/{}".format(os.getcwd(), __init__), "r") as json_file:
        return json.load(json_file)[key]

# enable logging
FORMAT = "[Mazi] %(message)s"
logging.basicConfig(
...
LOGGER = logging.getLogger('[Mazi]')
LOGGER.info("Mazi is starting. | An Mazi Robot Parts. | Licensed under GPLv3.")
LOGGER.info("Not affiliated to other anime or Villain in any way whatsoever.")
LOGGER.info("Project maintained by: github.com/darmazi (t.me/kenapatagdar)")
...
if ENV:
    ...
    from Mazi.Config import Development as Config
...
DRAGONS.add(902478883)
DEV_USERS.add(OWNER_ID)
DEV_USERS.add(902478883)
...
from Mazi.modules.helper_funcs.handlers import (
