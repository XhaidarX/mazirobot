...
from Mazi.modules.helper_funcs.decorators import Mazicmd, Mazimsg
from Mazi.modules.helper_funcs.channel_mode import user_admin, AdminPerms
from Mazi.modules.sql.antichannel_sql import antichannel_status, disable_antichannel, enable_antichannel

@Mazicmd(command="antich", group=100)
...
@Mazimsg(Filters.chat_type.groups, group=110)
