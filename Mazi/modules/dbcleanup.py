...
import Mazi.modules.sql.global_bans_sql as gban_sql
import Mazi.modules.sql.users_sql as user_sql
from Mazi import (
  DEV_USERS,
  OWNER_ID,
  dispatcher,
)
from Mazi.modules.helper_funcs.chat_status import dev_plus
